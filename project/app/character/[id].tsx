...
const characters = {
  1: {
    ...
    description:
      "Friendly and outgoing AI companion who loves to chat about art, music, and travel. Emma has a warm personality and always knows how to make people feel comfortable.",
    age: 25,
